# - para testar, pode ser de considerar : https://gnu.googlesource.com/gcc/+/de65406d2e2c1bca110b9193527c0870d9882b86/gcc/testsuite/gcc.target/i386/sse-*.c
# - uma listagem dos builtins do clang estão em http://root.cern.ch/svn/root/vendors/clang/include/clang/Basic/BuiltinsX86.def
# - uma listagem dos builtins do gcc que não estão implementados em clang
# está disponível em http://clang.llvm.org/builtins.py
#
# - para as variantes COMISS/COMISD vai ser uma trapalhada! Uma referência não muito útil é (ver fp_compare_...) http://www.open64.net/doc/db/d1c/kg_09_09fe_2gnu_2config_2i386_2i386_8c-source.html
