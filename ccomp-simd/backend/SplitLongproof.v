...
Remark eval_builtin_1:
  forall bf le id adata sg arg1 varg1 vres,
  eval_expr ge sp e m le arg1 varg1 ->
  lookup_builtin_function id sg = Some bf ->
  builtin_function_sem bf (varg1 :: nil) = Some vres ->
  eval_expr ge sp e m le (Ebuiltin (EF_builtin id adata  sg) (arg1 ::: Enil)) vres.
Proof.
...
Remark eval_builtin_2:
  forall bf le id adata sg arg1 arg2 varg1 varg2 vres,
  eval_expr ge sp e m le arg1 varg1 ->
  eval_expr ge sp e m le arg2 varg2 ->
  lookup_builtin_function id sg = Some bf ->
  builtin_function_sem bf (varg1 :: varg2 :: nil) = Some vres ->
  eval_expr ge sp e m le (Ebuiltin (EF_builtin id adata sg) (arg1 ::: arg2 ::: Enil)) vres.
Proof.
...
Proof.
  ...
  set (default := Ebuiltin (EF_builtin "__builtin_addl" None sig_ll_l) (a ::: b ::: Enil)).
  assert (DEFAULT:
...
Proof.
  ...
  set (default := Ebuiltin (EF_builtin "__builtin_subl" None sig_ll_l) (a ::: b ::: Enil)).
  assert (DEFAULT:
