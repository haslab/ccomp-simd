...
Definition read_as_zero (m: mem) (b: block) (ofs len: Z) : Prop :=
  ...
  Some (match chunk with
        ...
        | Mvec t => Vvec t (ArchiVec.vec_repr 0)
...
Proof.
  ...
  f_equal. destruct chunk; unfold decode_val; try (unfold decode_int; unfold rev_if_be; destruct Archi.big_endian; reflexivity).

rewrite proj_bytes_zero, decode_int_zero; reflexivity.
Qed.
