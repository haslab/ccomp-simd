...
Proof.
  intros. destruct ty; try destruct v; monadInv H.
...
Proof.
  intros. destruct ty; try destruct v; monadInv H; TailNoLabel.
Qed.
...
Proof.
  ...
  destruct m; try destruct v; monadInv H; eapply transl_memory_access_label; eauto; simpl; auto. 
...
- (* external function *)
  ...
  eapply external_call_symbols_preserved'; eauto. 
  exact symbols_preserved. exact varinfo_preserved.
unfold loc_external_result; rewrite H2; reflexivity.
  econstructor; eauto.
