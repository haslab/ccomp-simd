...
Definition eval_static_operation (op: operation) (vl: list aval): aval :=
  ...
  | Omakevec, v1::v2::nil => vecofdoubles v1 v2
  | Olowvec, v1::nil => lowvec v1
  | Ohighvec, v1::nil => hivec v1
...
Proof.
  ...
  inv H1; inv H0; simpl; auto with va; try constructor.
  inv H1; simpl; auto with va; try constructor.
  inv H1; simpl; auto with va; try constructor.
