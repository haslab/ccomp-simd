...
(*c Manipulating 64-bit integers: *)
  | Omakevec: operation                (**r [xd = d1 << 64 | d2] *)
  | Olowvec: operation                 (**r [d = low-word(x1)] *)
  | Ohighvec: operation                (**r [d = high-word(x1)] *)
(*c Boolean tests: *)
...
Definition eval_operation
  ...
  | Omakevec, v1::v2::nil => Some(Val.vecofdoubles v1 v2)
  | Olowvec, v1::nil => Some(Val.doubleofveclo v1)
  | Ohighvec, v1::nil => Some(Val.doubleofvechi v1)
...
Definition type_of_operation (op: operation) : list typ * typ :=
  ...
  | Omakevec => (Tfloat :: Tfloat :: nil, Tvec tt)
  | Olowvec => (Tvec tt :: nil, Tfloat)
  | Ohighvec => (Tvec tt :: nil, Tfloat)
...
Proof with (try exact I).
  ...
  destruct v0...
  destruct v0... 
  destruct v0; destruct v1; simpl; reflexivity.
  destruct v0... 
  destruct v0... 
