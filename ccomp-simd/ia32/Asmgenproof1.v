...
Proof.
  ...
  (* T128 *)
  monadInv H.
  rewrite (xreg_of_eq _ _ EQ). econstructor.
  split. apply exec_straight_one. simpl. unfold exec_load. rewrite H1. rewrite H0.
  eauto. auto.
  intuition Simplifs.
  (* single *)
...
Proof.
  ...
  (* T128 *)
  monadInv H.
  rewrite (xreg_of_eq _ _ EQ) in H0. econstructor.
  split. apply exec_straight_one. simpl. unfold exec_store. rewrite H1. rewrite H0.
  eauto. auto. 
  intros; Simplifs.
  (* single *)
...
Ltac ArgsInv :=
  ...
  | [ H: xreg_of _ = OK _ |- _ ] => simpl in *; rewrite (xreg_of_eq _ _ H) in *; clear H; ArgsInv
  | _ => idtac
  end.
