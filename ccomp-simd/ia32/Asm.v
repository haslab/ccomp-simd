...
(** SSE registers (used as such) *)

Inductive xreg: Type :=
  | XXMM0: xreg  | XXMM1: xreg  | XXMM2: xreg  | XXMM3: xreg
  | XXMM4: xreg  | XXMM5: xreg  | XXMM6: xreg  | XXMM7: xreg.
...
Lemma xreg_eq: forall (x y: freg), {x=y} + {x<>y}.
Proof. decide equality. Defined.
...
Inductive preg: Type :=
  ...
  | XR: xreg -> preg                    (**r SSE/XMM register *)
...
Inductive instruction: Type :=
  ...
  | Pmov_xx (rd: xreg) (r1: xreg)       (**r [mov] (128-bit int) *)
  | Pmov_xm (rd: xreg) (a: addrmode)
  | Pmov_mx (a: addrmode) (rs: xreg)
...
Definition exec_instr (f: function) (i: instruction) (rs: regset) (m: mem) : outcome :=
  ...
  | Pmov_xx rd r1 =>
      Next (nextinstr (rs#rd <- (rs r1))) m
  | Pmov_xm rd a =>
      exec_load Mint128 m a rs rd
  | Pmov_mx a r1 =>
      exec_store Mint128 m a rs r1 nil
  (** Moves with conversion *)
  | Pmovb_mr a r1 =>
