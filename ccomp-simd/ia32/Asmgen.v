...
Definition xreg_of (r: mreg) : res xreg :=
  match preg_of r with XR mr => OK mr | _ => Error(msg "Asmgen.xreg_of") end.
...
Definition mk_mov (rd rs: preg) (k: code) : res code :=
  ...
  | XR rd, XR rs => OK (Pmov_xx rd rs :: k)
...
Definition loadind (base: ireg) (ofs: int) (ty: typ) (dst: mreg) (k: code) :=
  ...
  | T128 =>
      do r <- xreg_of dst;
      OK (Pmov_xm r (Addrmode (Some base) None (inl _ ofs)) :: k)
  | Tlong =>
...
Definition storeind (src: mreg) (base: ireg) (ofs: int) (ty: typ) (k: code) :=
  ...
  | T128 =>
      do r <- xreg_of src;
      OK (Pmov_mx (Addrmode (Some base) None (inl _ ofs)) r :: k)
  | Tlong =>
...
Definition transl_load (chunk: memory_chunk)
  ...
  | Mint128 =>
      do r <- xreg_of dest; OK(Pmov_xm r am :: k)
  | Mint64 =>
...
Definition transl_store (chunk: memory_chunk)
  ...
  | Mint128 =>
      do r <- xreg_of src; OK(Pmov_mx am r :: k)
  | Mint64 =>
