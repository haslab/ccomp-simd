...
Inductive op_strength_reduction_cases: forall (op: operation) (args: list reg) (vl: list aval), Type :=
  ...
  | op_strength_reduction_case22: forall r1 v1, op_strength_reduction_cases (Osingleoffloat) (r1 :: nil) (v1 :: nil)
  | op_strength_reduction_case23: forall c args vl, op_strength_reduction_cases (Ocmp c) (args) (vl)
  | op_strength_reduction_case24: forall r1 r2 v1 n2, op_strength_reduction_cases (Omulf) (r1 :: r2 :: nil) (v1 :: F n2 :: nil)
  | op_strength_reduction_case25: forall r1 r2 n1 v2, op_strength_reduction_cases (Omulf) (r1 :: r2 :: nil) (F n1 :: v2 :: nil)
...
Definition op_strength_reduction_match (op: operation) (args: list reg) (vl: list aval) :=
  ...
  | Osingleoffloat, r1 :: nil, v1 :: nil => op_strength_reduction_case22 r1 v1
  | Ocmp c, args, vl => op_strength_reduction_case23 c args vl
  | Omulf, r1 :: r2 :: nil, v1 :: F n2 :: nil => op_strength_reduction_case24 r1 r2 v1 n2
  | Omulf, r1 :: r2 :: nil, F n1 :: v2 :: nil => op_strength_reduction_case25 r1 r2 n1 v2
...
Definition op_strength_reduction (op: operation) (args: list reg) (vl: list aval) :=
  ...
  | op_strength_reduction_case22 r1 v1 => (* Osingleoffloat, r1 :: nil, v1 :: nil *) 
      make_singleoffloat r1 v1
  | op_strength_reduction_case23 c args vl => (* Ocmp c, args, vl *) 
      let (c', args') := cond_strength_reduction c args vl in (Ocmp c', args')
  | op_strength_reduction_case24 r1 r2 v1 n2 => (* Omulf, r1 :: r2 :: nil, v1 :: F n2 :: nil *) 
      make_mulfimm n2 r1 r1 r2
  | op_strength_reduction_case25 r1 r2 n1 v2 => (* Omulf, r1 :: r2 :: nil, F n1 :: v2 :: nil *) 
